...
// Création de div
const newDiv = document.createElement("div");
previsionDiv.id = "previsionFormat";
        ...
        .then(data => {
            ...
            pressure.textContent = "Pression : " + data.list[0].main.pressure + " hPa";
             ...
             for (let i = 0; i < data.list.length; i += 8) {
                ...
                temperatureElement.textContent = `Température : ${Math.round(data.list[i].main.temp)}°C`;

                dayForecast.append(dayNameElement, iconElement, temperatureElement);
                weather.appendChild(dayForecast);
             }
...
divContain.append(titleDiv, inputSearch, newDiv); // ajout de tous les éléments à divContain
