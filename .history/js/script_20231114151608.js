...
function checkWeather(city) {
    fetch(API_URL + city)
        ...
        .then(data => {
            ...
            temperature.textContent = "Température : " + Math.round(data.list[0].main.temp) + "°C";
            feelsLike.textContent = "Temps Ressenti : " + Math.round(data.main.feels_like) + "°C";
            humidity.textContent = "Humidité : " + data.main.humidity + "%";
            DataWind.textContent = "Vitesse du vent : " + Math.floor(data.wind.speed) + " Km/h";
